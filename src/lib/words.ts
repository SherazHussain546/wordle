...
// In a real application, this list would be much larger.
export const WORDLIST = [
  'aback', 'abase', 'abate', 'abbey', 'abyss', 'acute', 'adobe', 'adopt',
  'adult', 'afoot', 'after', 'again', 'agent', 'agree', 'ahead', 'aisle',
  'alarm', 'album', 'alert', 'alien', 'alike', 'alive', 'allow', 'alone',
  'along', 'aloud', 'alpha', 'altar', 'alter', 'amber', 'ample', 'angel',
  'anger', 'angle', 'angry', 'ankle', 'apple', 'apply', 'apron', 'arbor',
  'arena', 'argue', 'arise', 'aroma', 'arose', 'array', 'arrow', 'ascot',
  'aside', 'askew', 'asset', 'atoll', 'attic', 'audio', 'audit', 'avoid',
  'await', 'awake', 'award', 'aware', 'awful', 'awoke', 'axiom', 'azure',
  'bacon', 'badge', 'badly', 'bagel', 'baker', 'balmy', 'balsa', 'banal',
  'bandy', 'barge', 'baron', 'basic', 'basil', 'basin', 'basis', 'batch',
  'bathe', 'baton', 'bayou', 'beach', 'beady', 'beast', 'beefy', 'began',
  'beget', 'begin', 'begun', 'being', 'belch', 'belie', 'belle', 'belly',
  'below', 'bench', 'beret', 'berry', 'berth', 'beset', 'betel', 'bevel',
  'bezel', 'bigot', 'bilge', 'billy', 'binge', 'bingo', 'biped', 'birch',
  ...
  'blurt', 'blush', 'board', 'boast', 'bobby', 'bongo', 'bonus', 'booby',
  'boost', 'booth', 'booty', 'booze', 'borax', 'borne', 'botch', 'bough',
  ...
  'bunch', 'bunny', 'burly', 'burst', 'bused', 'bushy', 'butch', 'buxom',
  ...
  'carve', 'caste', 'catch', 'cater', 'caulk', 'cause', 'cavil', 'cease',
  'cedar', 'cello', 'chafe', 'chain', 'chair', 'chalk', 'champ', 'chant',
  ...
  'conch', 'condo', 'conic', 'corny', 'couch', 'cough', 'could', 'count',
  'coupe', 'court', 'coven', 'cover', 'covet', 'covey', 'cower', 'coyly',
  'crack', 'craft', 'crane', 'crank', 'crash', 'crass', 'crate', 'crave',
  ...
  'filth', 'final', 'finch', 'finer', 'first', 'fishy', 'fixer', 'fjord',
  ...
  'geode', 'ghost', 'ghoul', 'giant', 'giddy', 'gipsy', 'girly', 'girth',
  ...
  'hilly', 'hinge', 'hoard', 'hobby', 'hoist', 'homer', 'honey', 'honor',
  ...
  'hyper', 'icily', 'icing', 'ideal', 'idiom', 'idiot', 'idler', 'idyll',
  'igloo', 'iliac', 'image', 'imbue', 'impel', 'imply', 'inane', 'inbox',
  'incur', 'index', 'inept', 'inert', 'infer', 'ingot', 'inlay', 'inlet',
  'inner', 'input', 'inter', 'intro', 'ionic', 'irate', 'irony', 'islet',
  'issue', 'itchy', 'ivory', 'jaunt', 'jazzy', 'jelly', 'jerky', 'jetty',
  'jewel', 'jiffy', 'joint', 'joist', 'joker', 'jolly', 'joust', 'judge',
  'judgy', 'juice', 'juicy', 'jumbo', 'jumpy', 'junta', 'junto', 'juror',
  ...
  'lumpy', 'lunar', 'lunch', 'lunge', 'lupus', 'lurch', 'lurid', 'lusty',
  'lying', 'lymph', 'lyric', 'macaw', 'macho', 'macro', 'madam', 'madly',
  ...
  'mower', 'mucky', 'mucus', 'muddy', 'mulch', 'mummy', 'munch', 'mural',
  'murky', 'mushy', 'music', 'musky', 'musty', 'myrrh', 'nadir', 'naive',
  'nanny', 'nasal', 'nasty', 'natal', 'naval', 'needy', 'neigh', 'nerdy',
  'nerve', 'never', 'newer', 'newly', 'nicer', 'niche', 'niece', 'night',
  'ninja', 'ninny', 'ninth', 'noble', 'nobly', 'noise', 'noisy', 'nomad',
  'noose', 'north', 'nosey', 'notch', 'novel', 'nudge', 'nurse', 'nutty',
  'nylon', 'nymph', 'oaken', 'obese', 'occur', 'ocean', 'octal', 'octet',
  'odder', 'oddly', 'offal', 'offer', 'often', 'olden', 'older', 'olive',
  ...
  'panel', 'panic', 'pansy', 'papal', 'paper', 'parer', 'parka', 'parry',
  'parse', 'party', 'pasta', 'paste', 'pasty', 'patch', 'patio', 'patsy',
  'patty', 'pause', 'paved', 'pawed', 'pawn', 'payee', 'payer', 'peace',
  ...
  'pilot', 'pinch', 'piney', 'pinky', 'pinto', 'piper', 'pique', 'pitch',
  ...
  'poppy', 'porch', 'poser', 'posit', 'posse', 'pouch', 'pound', 'pouty',
  ...
  'proxy', 'prude', 'prune', 'psalm', 'pubic', 'pudgy', 'puffy', 'pulpy',
  'pulse', 'punch', 'pupal', 'pupil', 'puppy', 'puree', 'purer', 'purge',
  ...
  'tibia', 'tidal', 'tiger', 'tight', 'tilde', 'timer', 'timid', 'tinge',
  'tinny', 'tippy', 'tipsy', 'titan', 'tithe', 'title', 'toast', 'today',
  ...
  'tweak', 'tweed', 'twice', 'twine', 'twirl', 'twist', 'twixt', 'tying',
  ...
  'utter', 'vague', 'valet', 'valid', 'valor', 'value', 'valve', 'vampy',
  ...
  'would', 'wound', 'woven', 'wowed', 'wrack', 'wrath', 'wreak', 'wreck',
  'wrest', 'wring', 'wrist', 'write', 'wrong', 'wrote', 'wrung', 'wryly',
  'yacht', 'yearn', 'yeast', 'yield', 'yodel', 'yokel', 'young', 'youth',
  'yummy', 'zebra', 'zesty', 'zonal'
];

// For this simple implementation, the list of valid guesses is the same as the word list.
// In a full-fledged Wordle clone, this would be a much larger list of all valid 5-letter words.
export const VALID_GUESSES = new Set(WORDLIST);
