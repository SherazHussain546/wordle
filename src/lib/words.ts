...
export const WORDLIST = [
  ...
  'boozy', 'borax', 'borne', 'bosom', 'boson', 'bossy', 'botch', 'bough', 
  ...
  'bring', 'brink', 'briny', 'brisk', 'broad', 'broil', 'broke', 'bronze', 
  ...
  'cower', 'coyly', 'crack', 'craft', 'crane', 'crank', 'crash', 'crass', 
  ...
  'dodge', 'dodgy', 'dogma', 'doing', 'dolly', 'donor', 'donut', 'dopey', 
  'doubt', 'dough', 'dowel', 'downy', 'dowry', 'dozen', 'draft', 'drain', 
  ...
  'fixer', 'fjord', 'flack', 'flail', 'flair', 'flake', 'flaky', 'flame', 
  ...
  'genie', 'genre', 'geode', 'ghost', 'ghoul', 'giant', 'giddy', 'gipsy', 
  ...
  'hence', 'heron', 'hilly', 'hinge', 'hoard', 'hobby', 'hoist', 'homer', 
  'honey', 'honor', 'horde', 'horny', 'horse', 'hotel', 'hotly', 'hound', 
  ...
  'joust', 'judge', 'judgy', 'juice', 'juicy', 'jumbo', 'jumpy', 'junta', 
  'junto', 'juror', 'kappa', 'karma', 'kayak', 'kebab', 'khaki', 'kinky', 
  'kiosk', 'kitty', 'knack', 'knave', 'knead', 'kneed', 'kneel', 'knelt', 
  'knife', 'knock', 'knoll', 'known', 'koala', 'kudos', 'label', 'labor', 
  ...
  'mover', 'movie', 'mower', 'mucky', 'mucus', 'muddy', 'mulch', 'mummy', 
  'munch', 'mural', 'murky', 'mushy', 'music', 'musky', 'musty', 'myrrh', 
  'nadir', 'naive', 'nanny', 'nasal', 'nasty', 'natal', 'naval', 'needy', 
  'neigh', 'nerdy', 'nerve', 'never', 'newer', 'newly', 'nicer', 'niche', 
  'niece', 'night', 'ninja', 'ninny', 'ninth', 'noble', 'nobly', 'noise', 
  'noisy', 'nomad', 'noose', 'north', 'nosey', 'notch', 'novel', 'nudge', 
  'nurse', 'nutty', 'nylon', 'nymph', 'oaken', 'obese', 'occur', 'ocean', 
  'octal', 'octet', 'odder', 'oddly', 'offal', 'offer', 'often', 'olden', 
  ...
  'patio', 'patsy', 'patty', 'pause', 'paved', 'pawed', 'pawn', 'payee', 
  ...
  'smith', 'smock', 'smoky', 'smote', 'snack', 'snail', 'snake', 'snaky', 
  ...
  'timid', 'tinge', 'tinny', 'tippy', 'tipsy', 'titan', 'tithe', 'title', 
  ...
  'tutor', 'twang', 'tweak', 'tweed', 'twice', 'twine', 'twirl', 'twist', 
  ...
  'valve', 'vampy', 'vapor', 'vault', 'vaunt', 'vegan', 'venom', 'venue', 
  ...
  'worst', 'worth', 'would', 'wound', 'woven', 'wowed', 'wrack', 'wrath', 
  'wreak', 'wreck', 'wrest', 'wring', 'wrist', 'write', 'wrong', 'wrote', 
  'wrung', 'wryly', 'yacht', 'yearn', 'yeast', 'yield', 'yodel', 'yokel', 
